...
@Entity
public class Employee implements Manager ,ReporterToManagers {
    ...
    public Employee(String firstName, String lastName, String title, Integer phoneNumber, String email, Double hireDate, Boolean manager) {
        this.idNumber = null;
